    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          ListTile(leading: Icon(Icons.person),title:Text("Name"),subtitle: Text("Sara Mostafa"),),
          ListTile(leading: Icon(Icons.email),title:Text("Email"),subtitle: Text("SaraMostafa@gmail.com"),)
        ],
      ),
    );
  }
